...
class EasyFloat {
    ...
    companion object {
        ...
        /**
         * 这是Yancey增加的方法，用于获取x坐标
         * @author Yancey
         * @param tag   浮窗标签
         */
        @JvmStatic
        @JvmOverloads
        fun getX(tag: String? = null): Int? = FloatingWindowManager.getHelper(tag)?.params?.x

        /**
         * 这是Yancey增加的方法，用于获取y坐标
         * @author Yancey
         * @param tag   浮窗标签
         */
        @JvmStatic
        @JvmOverloads
        fun getY(tag: String? = null): Int? = FloatingWindowManager.getHelper(tag)?.params?.y
