...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tv_updateNote.setText("""
                ...
                2. 新增：music指令的曲目名称支持补全提示
                3. 修复：重复的实体ID
                
                v0.2.8 20240508
                1. 修改：将方块ID和方块状态更新至1.21.0.23指令
                ...
                5. 修复：difficulty指令的难度等级有错误
                6. 修复：function指令的函数名错误地需要转义字符
                7. 修复：scoreboard指令的运算操作识别错误
                8. 修复：recipe指令的配方不支持*
