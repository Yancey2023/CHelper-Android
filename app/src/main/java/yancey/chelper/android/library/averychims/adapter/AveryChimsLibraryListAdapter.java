 ...
 */
public class AveryChimsLibraryListAdapter extends RecyclerView.Adapter<AveryChimsLibraryListAdapter.CommandListViewHolder> {

    private final Context context;
    private List<String> libraryNames;
    private final Consumer<String> onLibraryChoose;

    public AveryChimsLibraryListAdapter(Context context, Consumer<String> onLibraryChoose) {
    ...
    public CommandListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CommandListViewHolder(LayoutInflater.from(context).inflate(R.layout.layout_averychims_library_list_item, parent, false));
    }
