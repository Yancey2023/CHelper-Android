 ...
 * 公共命令库
 */
public class PublicLibraryListActivity extends CustomActivity<PublicLibraryListView> {

    @Override
    protected PublicLibraryListView createView(Consumer<CustomView> openView) {
        return new PublicLibraryListView(this, openView, CustomView.Environment.APPLICATION);
    }
