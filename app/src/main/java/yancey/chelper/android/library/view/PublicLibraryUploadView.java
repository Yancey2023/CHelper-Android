...
import yancey.chelper.android.library.util.MyInputFilter;
...
public class PublicLibraryUploadView extends CustomView {
    ...
    public void onCreateView(@NonNull Context context, @NonNull View view, @Nullable Object privateData) {
        ...
        view.findViewById(R.id.btn_preview).setOnClickListener(view1 -> {
            ...
            if (library != null) {
                openView((context1, openView, environment) ->
                        new PublicLibraryPreviewView(context1, openView, environment, library));
            }
        });
