...
public class FavoriteListAdapter extends RecyclerView.Adapter<FavoriteListAdapter.CommandListViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CommandListViewHolder holder, int position) {
        ...
        holder.mIv_edit.setOnClickListener(view -> new EditFavoriteDialog(context, this, data, holder.getAdapterPosition(), false).show());
    }
    ...
    public void bulkCopy() {
        ...
        Toast.makeText(context, "已批量复制", Toast.LENGTH_SHORT).show();
    }

    static class CommandListViewHolder extends RecyclerView.ViewHolder {
