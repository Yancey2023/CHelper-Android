...
public class Crunch {
	 ...
	 */
	public static redempt.crunch.CompiledExpression compileExpression(String expression) {
	 ...
	 * @return The compiled expression
	 */
	public static redempt.crunch.CompiledExpression compileExpression(String expression, EvaluationEnvironment env) {
