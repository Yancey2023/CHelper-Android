...
public class Operation implements Value {
	...
	private final redempt.crunch.token.Operator operator;
	private final Value first;
	private Value second;
	
	public Operation(redempt.crunch.token.Operator operator, Value value) {
		this.operator = operator;
		this.first = value;
	}
	
	public Operation(redempt.crunch.token.Operator operator, Value first, Value second) {
		this.operator = operator;
		this.first = first;
		this.second = second;
	}
